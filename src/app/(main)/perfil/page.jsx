...
export default function Page() {
  ...
  let myannouncement = UseServiceHook({
    accountId: info.accountId,
    page: 0,
    size: 5,
    title: "",
  ...
  contracted = contracted.paginationService;
  myannouncement = myannouncement.paginationService;
            ...
            <div className="flex w-full justify-between gap-10">
              <div className="flex flex-col items-center justify-center">
                <span className="font-bold text-xl">
                  {myannouncement.page.totalElements}
                </span>
        ...
        <section className="w-full flex flex-col gap-4 h-full">
          <section className="w-full h-full">
            <div className="bg-white rounded-xl flex flex-col h-full p-2 gap-4">
              ...
              <div className="flex flex-col gap-4">
                {myannouncement.content.map((item, index) => {
                  return (
                    <CardService
                      key={index}
          ...
          <section className="w-full h-full">
            <div className="bg-white rounded-xl flex flex-col h-full p-2 gap-4">
              ...
              <div className="flex flex-col gap-4">
                {contracted.content.map((item, index) => {
                  return (
                    <CardService
                      key={index}
                      created_at={item.creationDate}
